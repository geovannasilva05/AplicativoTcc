...
class CupomWidget extends StatefulWidget {
  const CupomWidget({Key? key}) : super(key: key);

  @override
  _CupomWidgetState createState() => _CupomWidgetState();
}
                ...
                children: [
                  Align(
                    ...
                    child: FlutterFlowButtonTabBar(
                      ...
                      backgroundColor: Color(0x4C766AEB),
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  16.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            'Fretes Grátis em Livros de Suspense',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily:
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    16.0, 0.0, 0.0, 0.0),
                                            child: Text(
                                              'Cupom de Desconto já resgatado',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyLarge
                                                      .override(
